...
import (
	...
	"os"
	"path/filepath"
	"region/miniSQL/src/API"
	"region/miniSQL/src/BackEnd"
	"region/miniSQL/src/BufferManager"
	"region/miniSQL/src/CatalogManager"
	"region/miniSQL/src/Interpreter/parser"
...
var getRPCInput = make(chan string, 1)
...
func runShell(r chan<- error, in chan string, out chan string) {
	ll := liner.NewLiner()
	defer ll.Close()
